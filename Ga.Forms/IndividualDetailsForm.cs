    ...
    public partial class IndividualDetailsForm : Form
    {
        ...
        public IndividualDetailsForm(IIndividual individual)
        {
            ...
            if (individual.Parents != null && individual.Parents.First != null)
            {
                ...
                linkLabel3.Links.Add(5, 1).Enabled = false;
            }
            else
            {
            ...
            if (individual.Parents != null && individual.Parents.Second != null)
            {
                ...
                linkLabel4.Links.Add(5, 1).Enabled = false;
            }
            else
            {
            ...
            label13.Text = string.Format("{0} = {1}", individual.Genome[0].Value, individual.Genome[0].Bits.ToString());
            label14.Text = string.Format("{0} = {1}", individual.Genome[1].Value, individual.Genome[1].Bits.ToString());
        ...
        {
            using (var individualDetails = new IndividualDetailsForm(individual.Parents.First))
            {
                individualDetails.ShowDialog(this.Owner);
            }
        }

        private void linkLabel2_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            using (var individualDetails = new IndividualDetailsForm(individual.Parents.Second))
            {
                individualDetails.ShowDialog(this.Owner);
            }
        }
